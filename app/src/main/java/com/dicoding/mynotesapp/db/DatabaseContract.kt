...
object DatabaseContract {
    ...
    class NoteColumns: BaseColumns{
        companion object {
            ...
            // Untuk membuat URI content://com.dicoding.mynotesapp/note Atau akan digunakan untuk identifikasi provider mana yang akan di akses.
            // Variabel CONTENT_URI: Di sini kita menggabungkan base authority dengan scheme dan nama tabel, nanti string yang akan tercipta adalah "content://com.dicoding.mynotesapp/note". Artinya dari string "content://com.dicoding.mynotesapp/note" berarti kita akan mencoba untuk akses data tabel Note dari provider NoteProvider.
